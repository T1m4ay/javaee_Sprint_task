...
public class DBManager {
    ...
    public static final String url = "jdbc:postgresql://localhost:5432/final_project_bitlab";
...
//    public static NewsCategories getCategoriesById(Long id) {
...
//                    newsCategories.setId(resultSet.getLong("id"));
...
//            statement.setLong(2, comments.getUser().getId());
